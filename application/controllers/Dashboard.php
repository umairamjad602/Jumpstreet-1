...
class Dashboard extends Admin_Controller 
{
	...
	public function index()
	{
        ...
        $this->data['total_stock'] = $this->model_stock->countTotalStock();
        $this->data['total_loan'] = $this->model_loan->countTotalLoan();
        $this->data['total_expanse'] = $this->model_expanse->countTotalExpanse();
