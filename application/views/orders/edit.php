...
//                        $stock_data = $this->model_stock->getStockData();
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td><input type="number" min="0" oninput="this.value = Math.abs(this.value)" name="qty[]" id="qty_<?php echo $x; ?>" class="form-control" required onchange="getTotal(<?php echo $x; ?>)" value="<?php echo $val['qty'] ?>" autocomplete="off"></td>
                          <td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" min="0" oninput="this.value = Math.abs(this.value)" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="subAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
