    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/storewiseByStartToEnd') ?>" method="POST">

              <div class="form-group">
                  <label for="start_date">Start From</label>
                  <input type="date" class="form-control" id="start_from" value="<?php echo $start_from ?>" required name="start_from">
              </div>

              <div class="form-group">
                  <label for="end_date">End To</label>
                  <input type="date" class="form-control" id="end_to" name="end_to" value="<?php echo $end_to ?>" required onclick="checkDate()">
              </div>
