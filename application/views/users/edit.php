            ...
            <form role="form" action="<?php base_url('users/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="store" name="store[]" multiple>
                    <option value="">Select store</option>
                    <?php foreach ($store_data as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if(in_array($v['id'],json_decode($user_data['store_id']))) { echo "selected='selected'"; } ?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
