          ...
          <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-teal">
                    ...
                    <a href="<?php echo base_url('loan/') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-maroon">
                    ...
                    <a href="<?php echo base_url('expanse/') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
