                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td>Stock</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createStock" <?php
                              if($serialize_permission) {
                                  if(in_array('createStock', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateStock" <?php
                              if($serialize_permission) {
                                  if(in_array('updateStock', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewStock" <?php
                              ...
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteStock" <?php
                              if($serialize_permission) {
                                  if(in_array('deleteStock', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                      </tr>
                      ...
                      <tr>
                          <td>Loan</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createLoan" <?php
                              if($serialize_permission) {
                                  if(in_array('createLoan', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateLoan" <?php
                              if($serialize_permission) {
                                  if(in_array('updateLoan', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewLoan" <?php
                              if($serialize_permission) {
                                  if(in_array('viewLoan', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteLoan" <?php
                              if($serialize_permission) {
                                  if(in_array('deleteLoan', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                      </tr>
                      ...
                      <tr>
                          <td>Expanse</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createExpanse" <?php
                              if($serialize_permission) {
                                  if(in_array('createExpanse', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateExpanse" <?php
                              if($serialize_permission) {
                                  if(in_array('updateExpanse', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewExpanse" <?php
                              if($serialize_permission) {
                                  if(in_array('viewExpanse', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteExpanse" <?php
                              if($serialize_permission) {
                                  if(in_array('deleteExpanse', $serialize_permission)) { echo "checked"; }
                              }
                              ?>></td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <td> - </td>
                          <td>
                              <input type="checkbox" name="permission[]" id="permission" value="endOfDay" <?php
                              if($serialize_permission) {
                                  if(in_array('endOfDay', $serialize_permission)) { echo "checked"; }
                              }
                              ?>>
                          </td>
                          <td> - </td>
