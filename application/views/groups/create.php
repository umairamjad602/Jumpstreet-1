                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td>Stock</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createStock"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateStock"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewStock"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteStock"></td>
                      </tr>
                      <tr>
                        <td>Tables</td>
                      ...
                      <tr>
                          <td>Loan</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createLoan"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateLoan"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewLoan"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteLoan"></td>
                      </tr>
                      <tr>
                          <td>Expanse</td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="createExpanse"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="updateExpanse"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="viewExpanse"></td>
                          <td><input type="checkbox" name="permission[]" id="permission" value="deleteExpanse"></td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <td> - </td>
                          <td> - </td>
                          <td> <input type="checkbox" name="permission[]" id="permission" value="endOfDay"> </td>
                          <td> - </td>
                      </tr>
                    </tbody>
                  </table>
