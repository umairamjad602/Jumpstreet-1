<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(in_array('createExpanse', $user_permission) || in_array('updateExpanse', $user_permission) || in_array('viewExpanse', $user_permission) || in_array('deleteExpanse', $user_permission)): ?>
           <li id="expanseMainNav"><a href="<?php echo base_url('expanse/') ?>"><i class="fa fa-files-o"></i> <span>Expanse</span></a></li>
        <?php endif; ?>

        <?php if(in_array('createLoan', $user_permission) || in_array('updateLoan', $user_permission) || in_array('viewLoan', $user_permission) || in_array('deleteLoan', $user_permission)): ?>
           <li id="loanMainNav"><a href="<?php echo base_url('loan/') ?>"><i class="fa fa-files-o"></i> <span>Loan</span></a></li>
        <?php endif; ?>
        ...
        <?php if(in_array('createStock', $user_permission) || in_array('updateStock', $user_permission) || in_array('viewStock', $user_permission) || in_array('deleteStock', $user_permission)): ?>
           <li id="storesMainNav"><a href="<?php echo base_url('stock/') ?>"><i class="fa fa-files-o"></i> <span>Stock</span></a></li>
        <?php endif; ?>
            ...
            <li class="treeview" id="ReportMainNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('viewReport', $user_permission)): ?>
                  ...
                  <li id="storeReportSubMenu"><a href="<?php echo base_url('reports/storewiseByStartToEnd') ?>"><i class="fa fa-circle-o"></i> Total Store wise</a></li>
                  <li id="storeReportSubMenu"><a href="<?php echo base_url('reports/discount') ?>"><i class="fa fa-circle-o"></i> Discount </a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>z
